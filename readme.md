...
Сервис автоматически применяет миграции при старте и включает cron-задачу по расписанию. Дополнительных команд или файлов не требуется, все настройки берутся из .env.

В example.env уже заполнены данные для тестового запуска приложения. Таблица для проверки тестового задания доступна по ссылке: https://docs.google.com/spreadsheets/d/1Mpsvr3AQcUkXuQCa1hNF3kvMHrph9z5akNzJgBGuE3o/edit?gid=546504237#gid=546504237
